  ...
  await transporter.sendMail({
    ...
    html: `
      <div style="font-family: sans-serif; padding: 1rem;">
        ...
        <a href="https://khrcha.onrender.com/transctions" style="padding: 10px 20px; background: #23BBA9; color: white; text-decoration: none; border-radius: 5px;">Add Today's Transaction</a>
